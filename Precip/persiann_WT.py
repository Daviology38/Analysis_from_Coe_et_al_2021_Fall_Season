    ...
    for j in range(9, 12, 1):
        for k in range(1, 32, 1):
            if j == 9 and k == 31:
                ...
                dates.append(
                    "H:/persiann-cdr/files/PERSIANN-CDR_v01r01_"
                    + str(i)
                    + str(jnew)
                    + str(knew)
                    + ".nc"
...
x = sio.loadmat(
    "C:/Users/CoeFamily/OneDrive - University of Massachusetts Lowell - UMass Lowell/Autumn WTs/SON_3wtprogression.mat"
)
...
# load the matlab progression data
x = sio.loadmat(
    "C:/Users/CoeFamily/OneDrive - University of Massachusetts Lowell - UMass Lowell/Autumn WTs/SON_4wtprogression.mat"
)
eseason = x["Earlyseason"]
