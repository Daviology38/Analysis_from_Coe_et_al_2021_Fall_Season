...
data = sio.loadmat("C:/Users/CoeFamily/OneDrive - University of Massachusetts Lowell - UMass Lowell/WTs_general/era5_mam_jan21_85/CI_results.mat")
clustvals = data["K"][:,6]
...
storage[0,:] = (storage[0,:] / 1240) * 100
storage[1,:] = (storage[1,:] / 1200) * 100
storage[2,:] = (storage[2,:] / 1240) * 100
...
storage25[0,:] = (sep_sort[24,:] / 1240) * 100
storage25[1,:] = (oct_sort[24,:] / 1200) * 100
storage25[2,:] = (nov_sort[24,:] / 1240) * 100

storage975[0,:] = (sep_sort[974,:] / 1240) * 100
storage975[1,:] = (oct_sort[974,:] / 1200) * 100
storage975[2,:] = (nov_sort[974,:] / 1240) * 100
...
#ax1.plot(('8','8'),(bot[0][7]+0.25, top[0][7]-0.25),color='black',linewidth=5.0)
...
#ax2.plot(('8','8'),(bot[1][7]+0.25, top[1][7]-0.25),color='black',linewidth=5.0)
...
#ax3.plot(('8','8'),(bot[2][7]+0.25, top[2][7]-0.25),color='black',linewidth=5.0)

fig.suptitle("Monthly WT Occurence", fontsize=20)

plt.savefig("WT_monthly_mam_7.png", bbox_inches='tight')
