...
mat_contents = sio.loadmat(
    "C:/Users/CoeFamily/Documents/David College Class Work/Research/era5_son_oct2019_run/era5_son_new/era5_sep.mat"
)
mat_contents3 = sio.loadmat(
    "C:/Users/CoeFamily/Documents/David College Class Work/Research/era5_son_oct2019_run/era5_son_new/era5_oct.mat"
)
mat_contents4 = sio.loadmat(
    "C:/Users/CoeFamily/Documents/David College Class Work/Research/era5_son_oct2019_run/era5_son_new/era5_nov.mat"
)
...
binscorr = np.arange(-1.0, 1.0, 0.1)
...
# ax.ylim(0,100,10)
# ax.xlim(-1,1,.1)
ax[0, 0].set_title("H500", fontsize=16)
...
ax[0, 1].set_title("MSLP", fontsize=16)
ax[0, 1].set_ylabel("% of days", fontsize=14)
ax[0, 1].set_xlabel("mb", fontsize=14)
...
ax[1, 0].set_title("U850", fontsize=16)
ax[1, 0].set_ylabel("% of days", fontsize=14)
ax[1, 0].set_xlabel("m/s", fontsize=14)
...
ax[1, 1].set_title("V850", fontsize=16)
ax[1, 1].set_ylabel("% of days", fontsize=14)
ax[1, 1].set_xlabel("m/s", fontsize=14)

for (m, n), subplot in np.ndenumerate(ax):
    subplot.set_xlim(-1, 1)
    subplot.set_ylim(0, 20)

plt.suptitle("Correlation Coefficient", fontsize=20)
...
for i in range(7):
    temp = (
        df.Correlation[groups[i + 1].values].sort_values(ascending=False).index.values
    )
